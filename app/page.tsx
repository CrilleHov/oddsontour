    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col items-center gap-4 pt-4 text-center">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
          ...
          ihop inför finalen – och på kvällen dricker vi öl och har det gött.
        </p>

        <div className="flex items-center justify-center gap-3">
          <a
            href="https://www.instagram.com/racetosand/"
            target="_blank"
            rel="noreferrer"
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <QuickLink href="/uppdatera" icon={Settings} title="Uppdatera" desc="Admin: uppdatera leaderboard" />
      </section>
    </div>
  )
}
